...
macd_line, signal_line, macd_hist = ic.macd(
    val_1d["close"], macd_fast, macd_slow, macd_sig
)
...
print(
    f"  Current: {mc['total_trades']} trades | WR={mc['win_rate']:.1f}% | PnL=${mc['total_pnl']:.2f} | Sharpe={mc['sharpe_ratio']:.2f}"
)
...
print(
    f"  Elder: {me['total_trades']} trades | WR={me['win_rate']:.1f}% | PnL=${me['total_pnl']:.2f} | Sharpe={me['sharpe_ratio']:.2f}"
)
